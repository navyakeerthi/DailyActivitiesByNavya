...
public class UsersService 
{
	...
	StringBuffer result;
	public String retrieveUsers(String key) throws ClientProtocolException, IOException, URISyntaxException
	{
		String url=rb.getString("usersurl");
	...
	public void insertUsersToDb(String result)
	{
